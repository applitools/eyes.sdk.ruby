...
module.exports = function (tracker, test) {
    ...
    addHook(
        'beforeEach',
        ruby`@eyes = eyes(is_visual_grid: ${test.vg}, is_css_stitching: ${test.config.stitchMode === 'CSS'}, branch_name: ${test.branchName}, parent_branch_name: ${test.parentBranchName})`,
    )
